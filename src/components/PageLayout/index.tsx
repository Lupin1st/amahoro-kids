    ...
    <div className="relative flex grow flex-col bg-slate-850 py-36">
      ...
      <div className="container relative flex grow flex-col px-4">
        ...
        <div className="mt-auto grid grid-cols-1 gap-4 pt-20 md:grid-cols-2 lg:gap-12">
          {/* <ExternalLink description={t('links.docs.description')} href={t('links.docs.href')} title={t('links.docs.title')} />
          <ExternalLink description={t('links.source.description')} href={t('links.source.href')} title={t('links.source.title')} /> */}
        </div>
      </div>
    </div>
  );
